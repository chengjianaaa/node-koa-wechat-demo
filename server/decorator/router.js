...
export const get = path => assembleRouterDecorator({
  method: 'get',
  path: path
})
export const post = path => assembleRouterDecorator({
  method: 'post',
  path: path
})
export const del = path => assembleRouterDecorator({
  method: 'del',
  path: path
})
export const put = path => assembleRouterDecorator({
  method: 'put',
  path: path
})
